...
function createModel(definition) {
  return {
    ...
    save(data) {
      ...
      return Vue.http.post(me.proxy.save, data).then(response => response.data)
    },
    get(id) {
      let me = this

      return Vue.http.post(me.proxy.detail, { id }).then(response => response.data).then(response => {
    ...
    remove(model) {
      ...
      return Vue.http.post(me.proxy.remove, { id: model.id }).then(response => response.data).then(response => {
    ...
    list(params) {
      ...
      return Vue.http.post(me.proxy.list, params).then(response => response.data).then(response => {
...
files.keys().forEach(key => {
  ...
  models[name] = createModel(definition)
})
